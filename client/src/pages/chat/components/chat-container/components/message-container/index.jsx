...
const MessageContainer = () => {
    ...
    const {selectedChatType,selectedChatData,userInfo, selectedChatMessages,setSelectedChatMessages, isDownloading,setIsDownloading, setFileDownloadingProgress} = useAppStore();
    ...
    const renderDMMessages = (message) => {
        return (
            ...
            { message.messageType === "text" && 
                (<div className={`${message.sender !== selectedChatType._id ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50" : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20"} border inline-block p-4 rounded my-1 max-w-[50%] break-words`}>
                    {message.content}
                </div>)
            }
            {
