...
const MessageBar = () => {
    ...
    return (
        <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6">
            ...
            <button className="bg-[#8417ff] p-5  rounded-md focus:border-none hiver:bg-[#741bda] focus:outline-none focus:text-white duration-300 transition-all" onClick={handleSendMessage}>
